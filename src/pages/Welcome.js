  ...
  return (
    <IonPage>
      <IonContent >
        ...
        <p style={{width: '80%', marginLeft: '10%', textAlign: 'center'}}>Crooms Leadership has been working extremely hard to put on an event for our students, staff, and parents that showcases our students' unique talents. Feel free to look through this app for the art pieces, vote for your favorites, and donate if you want to see more events like this in the future.</p>
