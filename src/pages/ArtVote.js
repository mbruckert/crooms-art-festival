...
import { IonContent,IonButtons, IonBackButton, IonRadioGroup, IonItemDivider, IonListHeader, IonLabel, IonRadio, IonHeader, IonPage, IonTitle, IonToolbar, IonList, IonItem, IonText, IonIcon, IonButton, IonInput } from '@ionic/react';
...
const ArtVote = () => {
  ...
  const [cookies, setCookie] = useCookies(['artVoted']);
          ...
          <IonRadioGroup value={selectedTraditional} onIonChange={e => setSelectedTraditional(e.detail.value)}>
            ...
            {traditional.map((art) =>
              <IonItem>
                ...
                <IonLabel>{art.data.artist}</IonLabel>
